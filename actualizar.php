<?php
    ...
    $sql = "SELECT * FROM alumno WHERE cod_estudiante='$id'"; // consulta sql
    $query = mysqli_query($con, $sql); // ejecuta la consulta

    $row = mysqli_fetch_array($query); // obtiene los datos de la consulta
?>
...
<body>
  <div class="container mt-5">
    <form action="update.php" method="POST">
      ...
      <input type="hidden" name="cod_estudiante" value="<?php echo $row['cod_estudiante'] ?>"> <!-- campo oculto -->
